nx.define("ExtendedTooltipPolicy",nx.graphic.Topology.TooltipPolicy, {
	...
	"methods": {
		...
		// overwrite default behavior: hovering the link makes tooltip show up
		"enterLink": function(link){
			var topo = link.topology();
			topo.tooltipManager().openLinkTooltip(link);
		},

		// overwrite default behavior: leaving the node makes tooltip hide
		"leaveLink": function(link){
			this._tm.closeAll();
		},
